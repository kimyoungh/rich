...
class TradingTransformerDataset(Dataset):
    """
        Trader Dataset
    """
    def __init__(self, observations, action_series,
                rew_series, val_series, asset_idx=0):
        """
            Initialization
    ...
    def __getitem__(self, idx):
        ...
        values = torch.FloatTensor(
            self.val_series[idx, s_idx].astype(float))

        return assets_in, obs, actions, rewards, values