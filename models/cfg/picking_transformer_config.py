"""
    Configs for Picking Transformer
...
_TRADER_TRAIN_CONFIG = {
    ...
    'model_name': 'picking_transformer',
...
PICKING_TRANSFORMER_TRAIN_CONFIG = PICKING_TRANSFORMER_CONFIG.copy()
PICKING_TRANSFORMER_TRAIN_CONFIG.update(_TRADER_TRAIN_CONFIG)